...
programa {
  ...
  inteiro id, hsTrampo
  real rsValor, rsValorHora

  //Entrada dos Dados
  escreva("Informe o seu ID: ") leia(id)
  escreva("Informe as horas trabalhadas: ") leia(hsTrampo)
  escreva("Informe o valor por horas trabalhadas: ") leia(rsValor)

  //Processamento dos Dados
  rsValorHora = hsTrampo * rsValor


  //Saída dos Dados
  escreva("ID " + id + "\nSalário R$" + rsValorHora)
